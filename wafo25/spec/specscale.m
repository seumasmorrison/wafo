function [Sn,mn,mom]=specscale(So,m0n,m2n,plotflag)
%SPECSCALE  Scale spectral density so that the moments equals m0,m2.  
%
%  CALL: [Sn,mn,mo]=specscale(So,m0n,m2n,plotflag);
%
...
% History:
% revised pab 2008
% renamed from scalespec to specscale
% revised pab jan2004  
% by pab 20.09.2000
